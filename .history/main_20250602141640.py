...
def get_weather(location:str) -> str:
    return f"The Weather in {location} is 22 degree C."



#step 4
agents = Agent(
    instructions="You are a helpful assistant that can answer user questions.If the user asks anything about the weather, location, or temperature, always use the `get_weather` tool to fetch the data.  ",
    name='Assistant',
    tools=[get_weather]
    )
